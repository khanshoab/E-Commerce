...
$RECORD=mysqli_query($con, "SELECT * FROM producttable  where Pname like '%$serach_data_value%' ");
...
echo"
                    ...
                    <img src='../admin/products/$pro_img'>
                        ...
                        <p>";?>INR <?php echo number_format((float)$pro_price,2)?> <?php echo "</p>
